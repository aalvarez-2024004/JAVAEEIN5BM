        ...
        <div class="panel-formulario">
            ...
            <form action="" method="post" class="formulario">
                 ...
                 <div class="form-control">
                    <input class="input" type="datetime-local" name="txtFechaCompra" placeholder="Fecha de Compra" required>
                    <span class="input-border"></span>
                </div>

                <div class="form-control">
                    <input class="input" type="number" step="0.01" name="txtTotal" placeholder="Total (Q.)" required>
                    <span class="input-border"></span>
                </div>

                <div class="form-control">
                    <input class="input" type="number" name="txtCodigoProveedor" placeholder="Código Proveedor" required>
                    <span class="input-border"></span>
                </div>

                <div class="form-control">
                    <input class="input" type="number" name="txtCodigoEmpleado" placeholder="Código Empleado" required>
                    <span class="input-border"></span>
                </div>
                
                <div class="botones">
                    
                    <button type="submit" class="btn-add" name="btnAgregar">
                    ...
                    <button type="button" class="btn-update" name="btnActualizar-">
                    ...
                    <button type="submit" name="btnBuscar" value="agregar">
                        <div class="container">
                    ...
                    <button type="button" class="bin-button" title="Eliminar" name="btnEliminar">
