    ...
    <div class="contenedor-principal">
        <div class="panel-formulario">
            ...
            <form action="" method="post" class="formulario">
                ...
                <input type="text" id="txtIdEmpleado" autocomplete="off" name="txtIdEmpleado" class="input" placeholder="ID" />
                <input type="text" id="txtNombreEmpleado" autocomplete="off" name="txtNombreEmpleado" class="input" placeholder="Nombre Empleado" />
                <input type="text" id="txtApellido" autocomplete="off" name="txtApellido" class="input" placeholder="Apellido" />
                <input type="text" id="txtDireccion" autocomplete="off" name="txtDireccion" class="input" placeholder="Dirección" />
                <input type="text" id="txtTelefono" autocomplete="off" name="txtTelefono" class="input" placeholder="Teléfono" />
                <input type="email" id="txtCorreoElectronico" autocomplete="off" name="txtCorreoElectronico" class="input" placeholder="Correo Electrónico" />
                <input type="text" id="txtPuesto" autocomplete="off" name="txtPuesto" class="input" placeholder="Puesto" />

                <div class="botones">
                    <button type="submit" id="btnAgregar" name="btnAgregar" class="btn-insertar">
                    ...
                    <button type="submit" id="btnEditar" name="btnEditar" class="btn-actualizar">
                        <span class="icon">
                    ...
                    <button type="submit" id="btnBuscar" name="btnBuscar" class="btn-buscar">
                    ...
                    <button type="submit" id="btnEliminar" name="btnEliminar" class="btn-eliminar">
